...
const singleProduct = {
  ...
  is_variant: false,
  thumbnail:
    "http://157.230.240.97:8888/storage/media/20250628_104744_7f56f255-8747-492f-a62f-15aa3b63a1f9.jpg",
  rating_avg: 0,
  rating_count: 0,
  available_stock: 100,
  badges: [],
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[380px_auto_313px] pt-6 gap-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-4 rounded-full border border-slate-300 w-48 mt-2">
              <div
